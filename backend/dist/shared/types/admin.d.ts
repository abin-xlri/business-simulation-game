...
export interface TimerResponse extends AdminApiResponse<{
    success: boolean;
}> {
}
export interface AnnouncementResponse extends AdminApiResponse<{
    success: boolean;
}> {
}
export interface ForceSubmitResponse extends AdminApiResponse<{
    success: boolean;
    submission: any;
}> {
}
