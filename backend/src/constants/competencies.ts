...
export const COMPETENCIES = [
  {
    ...
    category: CompetencyCategory.ANALYTICAL_THINKING,
    weight: 1.0
  },
  {
    ...
    category: CompetencyCategory.STRATEGIC_PLANNING,
    weight: 1.0
  },
  {
    id: 'collaboration',
  ...
  },
  {
    ...
    category: CompetencyCategory.DECISION_MAKING,
    weight: 1.0
  },
  {
    id: 'communication',
  ...
  },
  {
    ...
    category: CompetencyCategory.ADAPTABILITY,
    weight: 1.0
  },
  {
    id: 'innovation',
  ...
  },
  {
    ...
    category: CompetencyCategory.EXECUTION,
    weight: 1.0
  }
];

// Task-Competency Mappings with Weights
export const TASK_COMPETENCY_MAPPINGS = {
...
export const TASK_NAMES = {
  [TaskType.ROUND1_TASK1_ROUTE_OPTIMIZATION]: 'Route Optimization',
  [TaskType.ROUND1_TASK2_PARTNER_SELECTION]: 'Partner Selection',
  [TaskType.ROUND2_GROUP_MARKET_SELECTION]: 'Group Market Selection',
  [TaskType.ROUND2_GROUP_BUDGET_ALLOCATION]: 'Group Budget Allocation',
  [TaskType.ROUND3_TASK1_CRISIS_WEB]: 'Crisis Web Management',
  [TaskType.ROUND3_TASK2_REACTIVATION_CHALLENGE]: 'Reactivation Challenge'
};
