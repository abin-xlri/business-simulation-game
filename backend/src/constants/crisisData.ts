...
export const CRISIS_ADVISORS: CrisisAdvisor[] = [
  {
    id: 'ritika_sen',
    name: 'Ritika Sen',
...
export const REACTIVATION_NODES: ReactivationNode[] = [
...
export const CRISIS_CONSTRAINTS = {
  MAX_ADVISORS: 2,
  MAX_ACTIONS: 3,
...
export const REACTIVATION_CONSTRAINTS = {
